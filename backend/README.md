...
## Project Structure
    ...
    ├── testapiautoteammemb_86805  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_86805`
...
2. Clone this repo and `cd testapiautoteammemb_86805`
